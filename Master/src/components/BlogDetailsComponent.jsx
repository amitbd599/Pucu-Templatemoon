      ...
      <div className="rounded-xl bg-white p-[30px] dark:bg-card">
        ...
        <div className="mt-[30px]">
          <p className="text-text">
            ...
            useful quantum properties and applications to explore than those we
          ...
          <p className="mt-[30px] text-text">
            Within a few decades, quantum technology is expected to become a key
            ...
            to researchers in the field are the superconducting properties of
            ...
            a quantum computer can be expected to solve real computing problems
            in practice, for example. The research community is convinced that
            there are many more revolutionary discoveries to be made in quantum
          ...
          <p className="mt-[30px] text-text">
            hese new superconductors continue to be highly enigmatic materials
            ...
            <div className="mt-[30px] md:mt-0 md:w-6/12">
              ...
              <ul className="mt-[20px] grid gap-2">
                ...
                <li className="flex items-start text-text">
                  ...
                  functionality to find specific cuisines, dishes, or
                  restaurants
                </li>
              </ul>
            </div>
          ...
          <p className="mt-[30px] text-text">
            ...
            large enough to be used in practice. Researchers need to work at
            meso scopic scale.
          </p>
        </div>
          ...
          <div className="parent mt-[40px]">
            <div className="flex w-full gap-[30px]">
              ...
              <div className="w-[80%] md:w-auto">
                ...
                <div className="mt-[10px]">
                  <p className="text-text">
                    We want to find out about all the other exciting properties
            ...
            <div className="mt-[10px] flex w-full gap-[30px] pl-[30px] md:pl-[80px]">
              ...
              <div className="w-[80%] md:w-auto">
                ...
                <div className="mt-[10px]">
                  <p className="text-text">
                    These new superconductors continue to be highly enigmatic
            ...
            <div className="mt-[10px] flex w-full gap-[30px] ">
              ...
              <div className="w-[80%] md:w-auto">
                ...
                <div className="mt-[10px]">
                  <p className="text-text">
                    To be able to explore revolutionary new discoveries, tools
                    are needed that can study and utilise the extraordinary
                    quantum properties at the minimal particle level, and can
                    also be scaled up large enough to be used in practice.
                    Researchers need to work at mesoscopic scale.
                  </p>
                </div>
              </div>
            </div>
